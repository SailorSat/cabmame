...
ROM_START( insidetrak )
	...
	ROMX_LOAD( "ver_151_01.u16", 0x00000, 0x20000, CRC(309180dd) SHA1(e32eafd8ad1b9e5d11027ab60b471bf97509f0e1), ROM_GROUPWORD | ROM_SKIP(2) | ROM_BIOS(0) )
	ROMX_LOAD( "ver_151_01.u17", 0x00002, 0x20000, CRC(186bfd55) SHA1(900645c8bdfe7ece07ec8515863f23aba81a3187), ROM_GROUPWORD | ROM_SKIP(2) | ROM_BIOS(0) )

	ROM_SYSTEM_BIOS( 1, "151.02", "Ver 151.02" )
	ROMX_LOAD( "ver_151_02.u16", 0x00000, 0x20000, CRC(869d4d41) SHA1(f66698ef872b3a4b903b2c8acbfec721b7191e94), ROM_GROUPWORD | ROM_SKIP(2) | ROM_BIOS(1) )
	ROMX_LOAD( "ver_151_02.u17", 0x00002, 0x20000, CRC(053535b3) SHA1(7ca368854589fe75de00847f76c2468beee7e443), ROM_GROUPWORD | ROM_SKIP(2) | ROM_BIOS(1) )

	ROM_SYSTEM_BIOS( 2, "151.03", "Ver 151.03" )
	ROMX_LOAD( "ver_151_03.u16", 0x00000, 0x20000, CRC(8354d059) SHA1(a88df7cc259c1c39316cc3bff9e08aa4e8d3d2c0), ROM_GROUPWORD | ROM_SKIP(2) | ROM_BIOS(2) )
	ROMX_LOAD( "ver_151_03.u17", 0x00002, 0x20000, CRC(ace4081d) SHA1(f57287ded53f8d127bcdc9e34b8adb356fe55e5e), ROM_GROUPWORD | ROM_SKIP(2) | ROM_BIOS(2) )

	ROM_SYSTEM_BIOS( 3, "151.07", "Ver 151.07" )
	ROMX_LOAD( "ver_151_07.u16", 0x00000, 0x20000, CRC(c08bcdbc) SHA1(1c8f147d8c555ace37002ffcce182a96f7ace8ee), ROM_GROUPWORD | ROM_SKIP(2) | ROM_BIOS(3) )
	ROMX_LOAD( "ver_151_07.u17", 0x00002, 0x20000, CRC(b7201df9) SHA1(8ec0f19de4d26bcd83bfd245387ade0471406472), ROM_GROUPWORD | ROM_SKIP(2) | ROM_BIOS(3) )
ROM_END
