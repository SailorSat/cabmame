...
// copyright-holders:Carl, Ariane Fugmann
...
DEFINE_DEVICE_TYPE(MCD, mcd2_device, "mcd2", "Mitsumi CD-ROM v2")
		...
		case CMD_GET_Q:
			if(m_cdrom_handle)
			{
				...
				else
				{
					...
					put_u24be(&m_cmdbuf[4], relative);
					m_cmdbuf[7] = 0;
					put_u24be(&m_cmdbuf[8], absolute);
					m_cmdbuf_count = 11;
					m_readcount = 0;
				}
			}
